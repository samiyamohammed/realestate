...
class AddPropertyPagelease extends StatelessWidget {
  const AddPropertyPagelease({super.key});
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      _buildPropertyTypeChip(
                                          context, state, 'Agricultural Land'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Industrial Land'),
                                      _buildPropertyTypeChip(context, state,
                                          'lands with machineries'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Other'),
                                    ],
                                  ),
