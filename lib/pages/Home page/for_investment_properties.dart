...
class ForInvestmentPropertiesPage extends StatelessWidget {
  const ForInvestmentPropertiesPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Filter properties where the status is 'For Investment'
    final forInvestmentProperties = properties
        .where((property) => property.status == 'For Investment')
        .toList();

    return Scaffold(
      appBar: AppBar(
        title: const Text("For Investment Properties"),
        leading: IconButton(
      ...
      body: ListView.builder(
        itemCount: forInvestmentProperties.length,
        itemBuilder: (context, index) {
          final property = forInvestmentProperties[index];
