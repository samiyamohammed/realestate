...
class ForRentPropertiesPage extends StatelessWidget {
  const ForRentPropertiesPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Filter properties where the status is 'For Rent'
    final forRentProperties =
        properties.where((property) => property.status == 'For Rent').toList();

    return Scaffold(
      appBar: AppBar(
        title: const Text("For Rent Properties"),
        leading: IconButton(
      ...
      body: ListView.builder(
        itemCount: forRentProperties.length,
        itemBuilder: (context, index) {
          final property = forRentProperties[index];
