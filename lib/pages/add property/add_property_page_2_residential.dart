...
class AddPropertyPageres extends StatelessWidget {
  const AddPropertyPageres({super.key});
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      _buildPropertyTypeChip(
                                          context, state, 'Villa'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Apartment'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Duplex'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Condominium'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Townhouse'),
                                      _buildPropertyTypeChip(
                                          context, state, 'Other'),
                                    ],
                                  ),
